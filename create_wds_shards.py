...
if __name__ == "__main__":
    ...
    #     args.min_duration,
    # )
    voxlingua107_path = pathlib.Path("/home/pdnguyen/Identification_ASR_practice/example_data")
    shards_path = pathlib.Path("/home/pdnguyen/Identification_ASR_practice/ouput_data_norm")
    ...
    write_shards(
        ...
        samples_per_shard=5000,  # Số lượng mẫu trong mỗi shard
        min_dur=3.0  # Thời lượng tối thiểu của mỗi đoạn âm thanh
    )