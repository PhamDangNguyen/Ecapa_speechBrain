...
if __name__ == "__main__":
    ...
    #     args.min_duration,
    # )
    voxlingua107_path = pathlib.Path("/home/pdnguyen/Identification_ASR_practice/data_real")
    shards_path = pathlib.Path("/home/pdnguyen/Identification_ASR_practice/output_data")
    ...
    write_shards(
        ...
        min_dur=1  # Thời lượng tối thiểu của mỗi đoạn âm thanh
    )